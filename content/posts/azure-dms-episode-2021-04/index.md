...
lead: "Azure DMS를 활용한 DB migration 에피소드" # Lead text
...
{{<openinnewtab href="https://azure.microsoft.com/ko-kr/services/database-migration/" title="Azure 데이터베이스 마이그레이션 가이드">}}↗  
{{<openinnewtab href="https://docs.microsoft.com/ko-kr/azure/dms/dms-tools-matrix" title="데이터 마이그레이션 시나리오에 사용할 수 있는 서비스 및 도구">}}↗
...
![](../resource/img8/Azure_SQL.png)

- tier 선택: general purpose, Gen5, 16 vCore (memory 81.6GiB)
※ 원본DB 16 vCPU 와 가장 근사치
- storage: 416 GiB

![](../resource/img8/SQL_Managed_Instance_price.png)

{{<openinnewtab href="https://azure.microsoft.com/ko-kr/pricing/details/azure-sql/sql-managed-instance/single/" title="Azure SQL Managed Instance 가격">}}↗

## 3. 작업 시나리오

![](../resource/img8/DMS_architecture.png)
...
![](../resource/img8/dms_creation_01.png)
...
{{<openinnewtab href="https://docs.microsoft.com/ko-kr/azure/dms/resource-scenario-status" title="Azure Database Migration Service에서 지원하는 마이그레이션 시나리오의 상태">}}↗
...
![](../resource/img8/storage_account_create.png)
...
![](../resource/img8/mig_complete_01.png)
