...
출처: {{<openinnewtab href="http://etutorials.org/SQL/microsoft+sql+server+2000/Part+IV+Transact-SQL/Chapter+32.+Distributed+Transaction+Processing/MS+DTC+Architecture/" title="http://etutorials.org/../MS+DTC+Architecture">}}↗
...
참고: {{<openinnewtab href="https://msdn.microsoft.com/ko-kr/library/ms188792(v=sql.120).aspx" title="https://msdn.microsoft.com/../ms188792(v=sql.120).aspx">}}↗
