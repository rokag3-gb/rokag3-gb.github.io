...
lead: "DTC 를 통한 distibution transaction" # Lead text
...
출처:{{<openinnewtab href="http://etutorials.org/SQL/microsoft+sql+server+2000/Part+IV+Transact-SQL/Chapter+32.+Distributed+Transaction+Processing/MS+DTC+Architecture/" title="http://etutorials.org/SQL/microsoft+sql+server+2000/Part+IV+Transact-SQL/Chapter+32.+Distributed+Transaction+Processing/MS+DTC+Architecture">}}↗

![](../resource/img_03/32fig07.gif)
