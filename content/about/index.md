...
>👨‍💻 주로 .NET을 사용하여 웹앱, 서버, 응용앱을 개발하고 그 어플리케이션이 서비스 목적을 달성하는지에 집중하고 있으며, 내부적으로는 Cloud Native 기반의 어플리케이션을 개발하고자 매진하고 있습니다.

>👨‍💻 물류, 제조, 유통, 여행, 클라우드 파트너 의 도메인을 경험한 평범한 개발자 입니다. 

>👨‍💻 물류 & 유통 SI 프로젝트 개발 4년, ERP 및 ASP.NET 개발 11년, BI & 데이터 시각화 프로젝트 2년, 클라우드 자동화 웹서비스 개발을 3년 정도 했었습니다. 프로젝트 매니징 업무에 나름대로의 철학을 갖고 있습니다.
