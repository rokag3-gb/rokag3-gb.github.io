...
- Golang, Kotlin, Java, Python, C# 등 몇가지 개발 스택을 활용하여 웹, 서버, 클라이언트를 개발하고 그 서비스가 비즈니스 목적을 달성할 수 있도록 힘쓰고 있습니다.

- 물류, 제조, 유통, 여행, 클라우드, 금융(증권) 도메인을 경험했습니다.

- 물류 & 유통 SI 프로젝트, ERP & 전사 API 개발, AI/ML 데이터 분석 & Self-BI 구축, 클라우드 자동화 SaaS 개발 5년, 금융(증권) FEP 주문, EAI 중계 서버 개발 등 을 경험 했습니다.

- 프로젝트 매니지먼트와 관련한 의사결정 기법, 업무 추진 방식, 비용 관리 등에 대해 경험을 갖고 있습니다. 팀 매니저로서 HR 관리에 대한 나름대로의 철학을 갖고 있습니다.
