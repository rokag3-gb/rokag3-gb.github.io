...
키 기반 매핑은 분산 시스템에서도 똑같이 적용되는 일반적인 문제더라고요.
select-case 기반 대기는 Go에서 가장 흔한 동기화 패턴이라 익혀두면 두루 쓰여요.
오늘은 문서만 손봤어요. 코드는 안정화돼서 한동안 그대로 둘 예정이에요.
이 글이 비슷한 hang으로 고생하는 분께 도움이 되면 좋겠어요.
다음 글은 좀 더 가벼운 주제로 준비 중이에요.
---
`eod`